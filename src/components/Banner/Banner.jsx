        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
          ...
          <div className="flex flex-col justify-center gap-6 sm:pt-0">
            ...
            <p data-aos="fade-up" className="text-sm text-gray-500 tracking-wide leading-5">
              ...
              voluptate voluptas incidunt quibusdam similique at assumenda saepe
              qui expedita vero. Nobis error alias illum placeat ad hic vitae
            ...
            <div className="flex flex-col gap-4">
              ...
              <div data-aos-delay = "500"  data-aos="fade-up" className="flex items-center gap-4">
